...
(function() {
  var arrayContainsObject, calculateWPRatio, cheerio, countCharacters, countPunctuation, countSentences, countWords, defaultOptions, formatSentence, getSentencesRank, intersectSentences, intersection, main, percentageLetter, re, request, splitContentToSentences, stripTags, toWordArray;
  ...
  splitContentToSentences = function(content) {
    var arr, i, p, p2, r, replace, s, t, temp, _i, _j, _len, _len1;
    replace = [];
